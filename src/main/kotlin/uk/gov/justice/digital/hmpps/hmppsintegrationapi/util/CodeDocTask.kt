...
import uk.gov.justice.digital.hmpps.hmppsintegrationapi.HmppsIntegrationApi
import java.io.File
...
class CodeDocTask {
  ...
  fun listControllerGatewayUse() {
    println("Controllers gateway use:-")
    val context = AnnotationConfigApplicationContext()
//    context.scan("src/main/kotlin")
//    context.scan("src/main/resources")
    context.environment.setActiveProfiles("local")
    println("Profiles: ${context.environment.activeProfiles.joinToString(", ")}")
    context.register(HmppsIntegrationApi::class.java)
    context.refresh()
