...
data class ContactSearchResponseItem(
  ...
  @Schema(description = "The address start date", example = "2022-10-01")
  val startDate: String?,
  @Schema(description = "The address end date", example = "2022-10-01")
  val endDate: String?,
  @Schema(description = "Indicates whether the contact had no fixed address", example = "false")
