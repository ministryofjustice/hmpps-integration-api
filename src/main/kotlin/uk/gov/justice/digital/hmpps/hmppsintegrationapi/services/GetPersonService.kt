...
class GetPersonService(
  ...
  /**
   * Returns a Nomis number from a HMPPS ID, taking into account an optionally provided prison filter
   * If the prisoner isn't found or their current location doesn't match the consumer's
