...
data class RunningActivity(
  ...
  @Schema(description = "The capacity of the activity", example = "10")
  val capacity: Int,
  @Schema(description = "The number of prisoners currently allocated to the activity", example = "8")
  val allocated: Int,
  @Schema(description = "The number of prisoners currently on the waitlist for the activity", example = "1")
  val waitlisted: Int,
