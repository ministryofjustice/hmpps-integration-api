...
import uk.gov.justice.digital.hmpps.hmppsintegrationapi.models.personalRelationships.PRNumberOfChildrenDto
...
class GetNumberOfChildrenForPersonService(
  ...
  fun execute(
  ...
  ): Response<PRNumberOfChildrenDto?> {
    ...
    return Response(
      data = numberOfChildren.data?.let { PRNumberOfChildrenDto(it.numberOfChildren) },
