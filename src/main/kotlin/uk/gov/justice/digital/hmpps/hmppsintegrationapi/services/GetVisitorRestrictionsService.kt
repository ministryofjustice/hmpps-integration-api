...
class GetVisitorRestrictionsService(
  ...
  fun execute(
    ...
    val personResponse = getPersonService.getPrisoner(hmppsId, requestContext)
    ...
    val consumerPrisonFilterCheck = consumerPrisonAccessService.checkConsumerHasPrisonAccess<PrisonerContactRestrictions>(prisonId, requestContext?.filters)
