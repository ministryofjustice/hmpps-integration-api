...
class ImageController(
  ...
  @GetMapping("{id}")
  fun getImage(@PathVariable id: Int, @RequestHeader("subject-distinguished-name") clientName: String): ResponseEntity<ByteArray> {
    ...
    auditService.createEvent(clientName, "GET_PERSON_IMAGE", "Image with id: $id has been retrieved")
