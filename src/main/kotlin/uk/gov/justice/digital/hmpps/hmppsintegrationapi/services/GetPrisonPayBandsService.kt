...
class GetPrisonPayBandsService(
  ...
  fun execute(
    ...
    val consumerPrisonFilterCheck = consumerPrisonAccessService.checkConsumerHasPrisonAccess<List<PrisonPayBand>>(prisonId, requestContext?.filters, upstreamServiceType = UpstreamApi.ACTIVITIES)
    if (consumerPrisonFilterCheck.errors.isNotEmpty()) {
      return consumerPrisonFilterCheck
    }

    val prisonRegimeResponse = activitiesGateway.getPrisonPayBands(prisonId, requestContext)
