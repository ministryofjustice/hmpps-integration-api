...
class PersonalRelationshipsGateway(
  ...
  fun getPrisonerContactRestrictions(prisonerContactId: Long): Response<PRPrisonerContactRestrictionsResponse?> {
    val result =
      webClient.request<PRPrisonerContactRestrictionsResponse>(
        HttpMethod.GET,
