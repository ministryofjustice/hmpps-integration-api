...
class PersonController(
  ...
  @Operation(
    ...
    description = "Only the first page will be returned. The page size is restricted to 100 records. If you require more records, then please narrow your search criteria.",
    responses = [
  ...
  fun getPersons(
    ...
    if (page > 1 || perPage > 100) {
      throw ValidationException("Only the first page will be returned. The page size is restricted to 100 records. If you require more records, then please narrow your search criteria.")
    }
