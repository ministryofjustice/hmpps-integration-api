...
class DeleteProcessedIntegrationTest : IntegrationTestBase() {
  ...
  fun setup() {
    ...
    val events =
      listOf(
        EventNotification(status = IntegrationEventStatus.PROCESSED, lastModifiedDateTime = moreThan24HoursAgo(), claimId = "ID", hmppsId = "ID", eventType = "ID", prisonId = "ID", url = "URL"),
        EventNotification(status = IntegrationEventStatus.PROCESSED, lastModifiedDateTime = lessThan24HoursAgo(), claimId = "ID", hmppsId = "ID", eventType = "ID", prisonId = "ID", url = "URL"),
        EventNotification(status = IntegrationEventStatus.PROCESSED, lastModifiedDateTime = moreThan24HoursAgo(), claimId = "ID", hmppsId = "ID", eventType = "ID", prisonId = "ID", url = "URL"),
        EventNotification(status = IntegrationEventStatus.PROCESSED, lastModifiedDateTime = lessThan24HoursAgo(), claimId = "ID", hmppsId = "ID", eventType = "ID", prisonId = "ID", url = "URL"),
        EventNotification(status = IntegrationEventStatus.PENDING, lastModifiedDateTime = moreThan24HoursAgo(), claimId = "ID", hmppsId = "ID", eventType = "ID", prisonId = "ID", url = "URL"),
        EventNotification(status = IntegrationEventStatus.PROCESSED, lastModifiedDateTime = lessThan24HoursAgo(), claimId = "ID", hmppsId = "ID", eventType = "ID", prisonId = "ID", url = "URL"),
      )
