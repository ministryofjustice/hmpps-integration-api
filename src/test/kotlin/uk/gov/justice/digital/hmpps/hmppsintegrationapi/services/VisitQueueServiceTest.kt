...
internal class VisitQueueServiceTest(
  ...
  @MockitoBean val consumerPrisonAccessService: ConsumerPrisonAccessService,
    ...
    beforeTest {
      ...
      whenever(getPersonService.getNomisNumberWithFiltering(hmppsId = eq(hmppsId), filters = any<ConsumerFilters>())).thenReturn(Response(NomisNumber(hmppsId)))
    ...
    describe("create visit message") {
      ...
      it("return error if getPersonService returns an error") {
        ...
        whenever(getPersonService.getNomisNumberWithFiltering(hmppsId = hmppsId, filters = filters)).thenReturn(Response(data = null, errors))
