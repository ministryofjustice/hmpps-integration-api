...
class OffenderRestrictionsControllerTest(
  ...
  @MockitoBean val auditService: AuditService,
    ...
    it("returns the correct non associations data") {
      ...
      val result = mockMvc.performAuthorised(nonAssociationsPath)
    ...
    // returns 404 not found if person not found
    // calls the non associations endpoint with the correct filters
  })
