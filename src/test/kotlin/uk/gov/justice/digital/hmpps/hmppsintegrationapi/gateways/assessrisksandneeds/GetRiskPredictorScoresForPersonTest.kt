        ...
        response.data.shouldBe(
          listOf(
            RiskPredictorScore(
              completedDate = LocalDateTime.parse("2026-01-16T16:22:54"),
              assessmentStatus = "COMPLETE",
              groupReconviction = GroupReconviction(scoreLevel = "HIGH", twoYears = 1),
              generalPredictor = GeneralPredictor(scoreLevel = "LOW", ogp2Year = 11),
              violencePredictor = ViolencePredictor(scoreLevel = "MEDIUM", twoYears = 6),
              riskOfSeriousRecidivism = RiskOfSeriousRecidivism(scoreLevel = "LOW", percentageScore = 12),
              sexualPredictor = SexualPredictor(indecentScoreLevel = "LOW", contactScoreLevel = "MEDIUM", ospDirectContactPercentageScore = 16, ospIndirectImagePercentageScore = 15),
              assessmentVersion = 1,
