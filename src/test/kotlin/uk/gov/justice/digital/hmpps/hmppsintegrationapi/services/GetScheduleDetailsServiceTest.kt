...
@ContextConfiguration(
  ...
  classes = [GetScheduleDetailsService::class],
)
class GetScheduleDetailsServiceTest(
  @MockitoBean val activitiesGateway: ActivitiesGateway,
  @MockitoBean val consumerPrisonAccessService: ConsumerPrisonAccessService,
  val getScheduleDetailsService: GetScheduleDetailsService,
) : DescribeSpec(
    {
      val prisonId = "MDI"
      ...
      it("should return a detailed activity schedule") {
        whenever(activitiesGateway.getActivityScheduleById(scheduleId)).thenReturn(Response(data = activitySchedule))

        val result = getScheduleDetailsService.execute(scheduleId, filters)
        result.data.shouldBe(activitySchedule.toActivityScheduleDetailed())
