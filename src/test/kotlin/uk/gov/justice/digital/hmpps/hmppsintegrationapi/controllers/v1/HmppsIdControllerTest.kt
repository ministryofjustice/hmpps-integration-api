  ...
  @MockitoBean val getPersonService: GetPersonService,
    ...
    describe("GET /v1/hmpps/id/nomis-number/by-hmpps-id/$nomisNumber") {
      ...
      beforeTest {
        ...
        whenever(getPersonService.getNomisNumberWithFiltering(nomisNumber, consumerFilters)).thenReturn(
          Response(
      ...
      it("returns a 500 INTERNAL SERVER ERROR status code when upstream api return expected error") {
        whenever(getPersonService.getNomisNumberWithFiltering(nomisNumber, consumerFilters)).doThrow(
          WebClientResponseException(500, "MockError", null, null, null, null),
        )
