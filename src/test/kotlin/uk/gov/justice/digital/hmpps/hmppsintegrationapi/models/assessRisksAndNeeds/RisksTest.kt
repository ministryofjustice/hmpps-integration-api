  ...
  DescribeSpec(
    {
      describe("#toRisks") {
        it("maps one-to-one attributes to Integration API attributes") {
          ...
          integrationApiRisks.riskToSelf.suicide.risk
            .shouldBe(arnRisks.riskToSelf.suicide.risk)
          integrationApiRisks.riskToSelf.selfHarm.risk
            .shouldBe(arnRisks.riskToSelf.selfHarm.risk)
          integrationApiRisks.riskToSelf.custody.risk
            .shouldBe(arnRisks.riskToSelf.custody.risk)
          integrationApiRisks.riskToSelf.hostelSetting.risk
            .shouldBe(arnRisks.riskToSelf.hostelSetting.risk)
          integrationApiRisks.riskToSelf.vulnerability.risk
