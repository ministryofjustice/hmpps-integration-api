  ...
  DescribeSpec(
    {
      ...
      describe("#types") {
        it("maps addressUsages only when addressType is not present") {
          ...
          val addressUsages =
            listOf(
              PrisonApiAddress.AddressUsage(expectedCode, expectedDescription),
            )
        ...
        it("addressUsage description is not present") {
          val addressUsages = listOf(PrisonApiAddress.AddressUsage("usage1", null))
        ...
        describe("when addressType is present") {
          it("maps addressUsages and addressType combined when both are present") {
            ...
            val addressUsages =
              listOf(
                PrisonApiAddress.AddressUsage("usage1", "usage description 1"),
                PrisonApiAddress.AddressUsage("usage2", "usage description 2"),
              )
