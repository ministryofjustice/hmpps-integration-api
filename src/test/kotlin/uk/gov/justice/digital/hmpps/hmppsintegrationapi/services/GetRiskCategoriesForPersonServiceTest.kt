  ...
  private val getRiskCategoriesForPersonService: GetRiskCategoriesForPersonService,
) : DescribeSpec(
    {
      ...
      beforeEach {
        ...
        whenever(getPersonService.getNomisNumberWithFiltering(hmppsId, filters)).thenReturn(Response(data = NomisNumber(nomisNumber)))
      ...
      it("gets a person from getPersonService") {
        ...
        verify(getPersonService, times(1)).getNomisNumberWithFiltering(hmppsId, filters)
      }
