      ...
      describe("When there are additional offences") {
        it("maps one-to-one attributes to integration API attributes") {
            ...
            supervisions = listOf(
              Supervision(
                ...
                additionalOffences = listOf(
                  AdditionalOffence(description = "additionalFoo", code = "12345")
                ),
              ...
              Supervision(
                ...
                additionalOffences = listOf(
                  AdditionalOffence(description = "additionalFoo2", code = "98765")
                ),
          ...
          integrationApiOffences.shouldBe(
            listOf(
              Offence(description = "foobar", hoCode = "05800", courtDates = listOf(
                LocalDate.parse("2009-07-07"))
              ),
              Offence(description = "additionalFoo", hoCode = "12345", courtDates = listOf(
                LocalDate.parse("2009-07-07"))
              ),
              Offence(description = "barbaz", hoCode = "05800", courtDates = listOf(
                LocalDate.parse("2010-07-07"))
              ),
              Offence(description = "additionalFoo2", hoCode = "98765", courtDates = listOf(
                LocalDate.parse("2010-07-07"))
              ),
            ),
          )
