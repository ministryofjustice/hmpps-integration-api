...
import uk.gov.justice.digital.hmpps.hmppsintegrationapi.config.FeatureFlagConfig.Companion.USE_NO_LAO_CONTEXT_EXCEPTION
...
) : DescribeSpec(
    {
      ...
      describe("GET $path") {
        ...
        it("fails with the appropriate error when LAO context has failed to be retrieved") {
          whenever(featureFlagConfig.isEnabled(USE_NO_LAO_CONTEXT_EXCEPTION)).thenReturn(true)
